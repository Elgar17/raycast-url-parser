  ...
  return (
    ...
    >
      <List.Item
        ...
        title="Decode"
        detail={<List.Item.Detail markdown={_decodeURI(input)} />}
      ...
      <List.Item
        icon={Icon.Lock}
        title="Encode"
        detail={<List.Item.Detail markdown={encodeURI(input)} />}
      ...
      {parsedUrl.host && (
        <List.Item
          icon={Icon.Link}
          title="Host"
          detail={<List.Item.Detail markdown={parsedUrl.host} />}
      ...
      {parsedUrl.hash && (
        <List.Item
          icon={Icon.Hashtag}
          title="Hash"
          detail={<List.Item.Detail markdown={parsedUrl.hash} />}
      ...
      {parsedUrl.protocol && (
        <List.Item
          icon={Icon.Pencil}
          title="Protocol"
          detail={<List.Item.Detail markdown={parsedUrl.protocol} />}
      ...
      {parsedUrl.port && (
        <List.Item
          icon={Icon.Monitor}
          title="Port"
          detail={<List.Item.Detail markdown={parsedUrl.port} />}
      ...
      {parsedUrl.username && (
        <List.Item
          icon={Icon.Person}
          title="Username"
          detail={<List.Item.Detail markdown={parsedUrl.username} />}
      ...
      {parsedUrl.password && (
        <List.Item
          icon={Icon.Key}
          title="Password"
          detail={<List.Item.Detail markdown={parsedUrl.password} />}
